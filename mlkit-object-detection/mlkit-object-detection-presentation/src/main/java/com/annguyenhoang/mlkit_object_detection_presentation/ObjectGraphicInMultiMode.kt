 ...
 */
class ObjectGraphicInMultiMode(
    ...
    init {
        ...
        boxPaint = Paint().apply {
            ...
            strokeWidth = resources.getDimensionPixelOffset(
                if (confirmationController.isConfirmed) {
                    com.annguyenhoang.core_ui.R.dimen.bounding_box_confirmed_stroke_width
                } else {
                    com.annguyenhoang.core_ui.R.dimen.bounding_box_stroke_width
                }
            ).toFloat()
            color = Color.WHITE
        }
        ...
        boxGradientStartColor =
            ContextCompat.getColor(context, com.annguyenhoang.core_ui.R.color.bounding_box_gradient_start)
        boxGradientEndColor =
            ContextCompat.getColor(context, com.annguyenhoang.core_ui.R.color.bounding_box_gradient_end)
        boxCornerRadius =
            resources.getDimensionPixelOffset(com.annguyenhoang.core_ui.R.dimen.bounding_box_corner_radius)
        ...
        scrimPaint = Paint().apply {
            shader = LinearGradient(
                ...
                ContextCompat.getColor(context, com.annguyenhoang.core_ui.R.color.object_confirmed_bg_gradient_start),
                ContextCompat.getColor(context, com.annguyenhoang.core_ui.R.color.object_confirmed_bg_gradient_end),
                TileMode.MIRROR
            )
        }
        ...
        minBoxLen =
            resources.getDimensionPixelOffset(com.annguyenhoang.core_ui.R.dimen.object_reticle_outer_ring_stroke_radius) * 2
    }
